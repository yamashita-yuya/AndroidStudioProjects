...
public class ScheduleEditActivity extends AppCompatActivity {
    ...
    public void onSaveTapped(View view){
        ...
        if(scheduleId != -1){
            ...
            Snackbar.make(findViewById(android.R.id.content),"Update Text", Snackbar.LENGTH_LONG).setAction("Back", new View.OnClickListener(){
                @Override
                public void onClick(View v) {
                    finish();
                }
            ...
            Toast.makeText(this, "Added Schedule", Toast.LENGTH_SHORT).show();
            finish();
        }
    }
